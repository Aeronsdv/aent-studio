                ...
                <div
                  className={cn(
                    ...
                    isActive 
                      ...
                      : "text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 hover:bg-zinc-200/50 dark:hover:bg-white/2"
                  )}
                >
        ...
        <header className="sticky top-0 z-40 bg-background/80 dark:bg-zinc-950/70 backdrop-blur-md border-b border-zinc-200/60 dark:border-white/5 px-6 md:px-8 py-4 flex items-center justify-between select-none transition-colors duration-300">
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className="lg:hidden p-2 -ml-2 rounded-xl text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-200/50 dark:hover:bg-white/5 transition-all cursor-pointer"
            >
            ...
            >
                      ...
                      <div
                        className={cn(
                          ...
                          isActive 
                            ...
                            : "text-zinc-555 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 hover:bg-zinc-200 dark:hover:bg-white/2"
                        )}
                      >
                        <item.icon className={cn(
                          "h-5 w-5 shrink-0",
              ...
              <div className="pt-6 border-t border-zinc-200 dark:border-white/5 space-y-3">
                <Link href="/" onClick={() => setIsMobileOpen(false)} className="block">
                  <div className="flex items-center gap-3 px-4 py-3 rounded-2xl text-zinc-555 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 hover:bg-zinc-200 dark:hover:bg-white/2 transition-all">
